  ...
  return (
    <div className={classes.root}>
      ...
      >
                  ...
                  <Avatar   src={`url(${process.env.PUBLIC_URL +'/resources/no-profile-picture.jpg'})`}/>
                  </div>
        <div  />
        <Divider />
        <List>
          {['Inbox', 'Starred', 'Send email', 'Drafts'].map((text, index) => (
            <ListItem className={classes.ListItemParent} button key={text}>
              ...
              <ListItemText className={classes.ListItemParent} primary={text} />
            </ListItem>
          ))}
        </List>
        <Divider variant="middle" />
        <List>
          {['All mail', '3asba', 'Spam'].map((text, index) => (
            <ListItem className={classes.ListItemParent} button key={text}>
              <ListItemIcon>{index % 2 === 0 ? <InboxIcon /> : <MailIcon />}</ListItemIcon>
              <ListItemText className={classes.ListItemParent} primary={text} />
            </ListItem>
